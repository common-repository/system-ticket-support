<div style="background:#f3f3f5;font-family: Helvetica, Arial, sans-serif;">
    <div style="max-width: 600px;margin: 0 auto;padding-top: 30px;">
        <div style="padding: 20px;text-align: center;background: #039be5;border-radius: 4px 4px 0 0;line-height: 0;">
            <img src="<?php echo esc_url(STS()->plugin_url('assets/images/logo-white.png')) ?>" style="width: 80px;">
        </div>
        ...
        <span style="font-size: 18px; display:block;margin-bottom: 30px">
            ...
            <div style="margin-bottom: 50px;">
                <p style="margin-bottom: 30px;">
                    <strong style="text-transform: capitalize"><?php echo esc_html($user_name) ?></strong><?php esc_html_e(' just reply your ticket', 'sts') ?>
                    <?php echo wp_kses_post($ticket_url) ?>
                </p>
        ...
        <div style="background:#039be5; width: 100%;border-radius:0 0 5px 5px; text-align: center">
            <a style="display:inline-block;padding: 10px 5px; text-decoration: none;line-height: 0;"
               ...
               title="<?php esc_attr_e('Facebook', 'sts') ?>">
                <img alt="<?php esc_attr_e('facebook','sts')?>"
                   ...
                   style="display:inline-block;padding: 10px 5px; text-decoration: none;line-height: 0;"><img
                        ...
                        style="width: 25px;"></a><a href="https://www.youtube.com/c/g5plus/"
                                                    title="<?php esc_attr_e('Youtube', 'sts') ?>"
                                                    style="display:inline-block;padding: 10px 5px; text-decoration: none;line-height: 0;"><img
