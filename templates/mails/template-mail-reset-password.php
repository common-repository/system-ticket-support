        ...
        <span style="font-size: 18px; display:block;margin-bottom: 30px">
            ...
            <div style="margin-bottom: 50px;">
                <p style="margin-bottom: 30px;">
					<?php esc_html_e( 'Please visit the link below to reset your password.', 'sts' ) ?>
                </p>
                <br>
                <div style="margin-bottom: 30px;">
                    <span style="padding:7px 14px;background:#039be5;border-radius:4px;"><?php echo wp_kses_post( $reset_password_url ) ?></span>
                </div>
