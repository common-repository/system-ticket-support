    ...
    <div style="max-width: 600px;margin: 0 auto;padding-top: 30px;">
        ...
        <span style="font-size: 18px; display:block;margin-bottom: 30px">
            ...
            <div style="margin-bottom: 50px;">
                <p>
                    <strong style="text-transform: capitalize;"><?php echo esc_html( $user_name ) ?></strong><?php esc_html_e( ' has just close your ticket ', 'sts' ) ?>
					<?php echo wp_kses_post( $ticket_url ) ?>
                </p>
                <p style="margin-bottom: 30px;">
					<?php esc_html_e( 'Tell us how do you feel about our service.', 'sts' ) ?>
                </p>
                <br>
                <div style="margin-bottom: 30px;">
                    <span style="padding:7px 14px;background:#039be5;border-radius:4px;"><?php echo wp_kses_post( $rating_url ) ?></span>
                </div>
                <p><?php esc_html_e( 'Notice: This link has expired in 7 days from you receive our mail.', 'sts' ) ?></p>
